...
function EditableTable(props) {
  ...
  useEffect(function () {
    ...
    value.forEach(function (current, index) {
      ...
      (_formRef$current5 = formRef.current) === null || _formRef$current5 === void 0 ? void 0 : _formRef$current5.setFieldsValue(_defineProperty({}, getRowKey(current, index), current));
    }, {});
