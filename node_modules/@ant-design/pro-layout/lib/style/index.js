...
var compatibleStyle = function compatibleStyle(token) {
  ...
  return _ref = {}, (0, _defineProperty2.default)(_ref, token.componentCls, (_token$componentCls = {
    width: '100%',
    height: '100%'
  }, (0, _defineProperty2.default)(_token$componentCls, "".concat(token.proComponentsCls, "-base-menu"), (_$concat6 = {
  ...
  }, (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-sub"), {
  ...
  }), (0, _defineProperty2.default)(_$concat6, "& ".concat(token.antCls, "-layout"), {
    backgroundColor: 'transparent',
    width: '100%'
  }), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-submenu-expand-icon, ").concat(token.antCls, "-menu-submenu-arrow"), {
    color: 'inherit'
  }), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu"), (_$concat = {
  ...
  }, (0, _defineProperty2.default)(_$concat, "".concat(token.antCls, "-menu-item"), {
    '*': {
      transition: 'none !important'
    }
  }), (0, _defineProperty2.default)(_$concat, "".concat(token.antCls, "-menu-item a"), {
    color: 'inherit'
  }), _$concat)), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu-inline"), (0, _defineProperty2.default)({}, "".concat(token.antCls, "-menu-selected::after,").concat(token.antCls, "-menu-item-selected::after"), {
    display: 'none'
  })), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-sub ").concat(token.antCls, "-menu-inline"), {
    backgroundColor: 'transparent!important'
  }), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-item:active, \n        ").concat(token.antCls, "-menu-submenu-title:active"), {
    backgroundColor: 'transparent!important'
  }), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu-light"), (0, _defineProperty2.default)({}, "".concat(token.antCls, "-menu-item:hover, \n            ").concat(token.antCls, "-menu-item-active,\n            ").concat(token.antCls, "-menu-submenu-active, \n            ").concat(token.antCls, "-menu-submenu-title:hover"), (0, _defineProperty2.default)({
  ...
  }))), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu:not(").concat(token.antCls, "-menu-horizontal)"), (_$concat$concat = {}, (0, _defineProperty2.default)(_$concat$concat, "".concat(token.antCls, "-menu-item-selected"), {
    ...
    borderRadius: token.borderRadius
  }), (0, _defineProperty2.default)(_$concat$concat, "".concat(token.antCls, "-menu-item:hover, \n            ").concat(token.antCls, "-menu-item-active,\n            ").concat(token.antCls, "-menu-submenu-title:hover"), (0, _defineProperty2.default)({
  ...
  })), _$concat$concat)), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-item-selected"), {
  ...
  }), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-submenu-selected"), {
  ...
  }), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu:not(").concat(token.antCls, "-menu-inline) ").concat(token.antCls, "-menu-submenu-open"), {
  ...
  }), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu-vertical"), (0, _defineProperty2.default)({}, "".concat(token.antCls, "-menu-submenu-selected"), {
    borderRadius: token.borderRadius,
  ...
  })), (0, _defineProperty2.default)(_$concat6, "".concat(token.antCls, "-menu-submenu:hover > ").concat(token.antCls, "-menu-submenu-title > ").concat(token.antCls, "-menu-submenu-arrow"), {
  ...
  }), (0, _defineProperty2.default)(_$concat6, "&".concat(token.antCls, "-menu-horizontal"), (_$concat5 = {}, (0, _defineProperty2.default)(_$concat5, "".concat(token.antCls, "-menu-item:hover,\n          ").concat(token.antCls, "-menu-submenu:hover,\n          ").concat(token.antCls, "-menu-item-active,\n          ").concat(token.antCls, "-menu-submenu-active"), {
    borderRadius: 4,
    transition: 'none',
  ...
  })), (0, _defineProperty2.default)(_$concat5, "> ".concat(token.antCls, "-menu-item, > ").concat(token.antCls, "-menu-submenu"), {
    paddingInline: 16,
    marginInline: 4
  }), (0, _defineProperty2.default)(_$concat5, "> ".concat(token.antCls, "-menu-item::after, > ").concat(token.antCls, "-menu-submenu::after"), {
    display: 'none'
  }), _$concat5)), _$concat6)), (0, _defineProperty2.default)(_token$componentCls, "".concat(token.proComponentsCls, "-top-nav-header-base-menu"), (_$concat9 = {}, (0, _defineProperty2.default)(_$concat9, "&".concat(token.antCls, "-menu"), (0, _defineProperty2.default)({
    ...
    color: 'inherit'
  })), (0, _defineProperty2.default)(_$concat9, "&".concat(token.antCls, "-menu-light"), (_$concat8 = {}, (0, _defineProperty2.default)(_$concat8, "".concat(token.antCls, "-menu-item:hover, \n            ").concat(token.antCls, "-menu-item-active,\n            ").concat(token.antCls, "-menu-submenu-active, \n            ").concat(token.antCls, "-menu-submenu-title:hover"), (0, _defineProperty2.default)({
  ...
  })), (0, _defineProperty2.default)(_$concat8, "".concat(token.antCls, "-menu-item-selected"), {
  ...
  }), _$concat8)), _$concat9)), _token$componentCls)), (0, _defineProperty2.default)(_ref, "".concat(token.antCls, "-menu-sub").concat(token.antCls, "-menu-inline"), {
    backgroundColor: 'transparent!important'
  }), (0, _defineProperty2.default)(_ref, "".concat(token.antCls, "-menu-submenu-popup"), (_$concat11 = {
    backgroundColor: 'rgba(255, 255, 255, 0.42)',
    '-webkit-backdrop-filter': 'blur(8px)',
    backdropFilter: 'blur(8px)'
  }, (0, _defineProperty2.default)(_$concat11, "".concat(token.antCls, "-menu"), (0, _defineProperty2.default)({
    background: 'transparent !important',
    backgroundColor: 'transparent !important'
  }, "".concat(token.antCls, "-menu-item:active, \n        ").concat(token.antCls, "-menu-submenu-title:active"), {
    backgroundColor: 'transparent!important'
  })), (0, _defineProperty2.default)(_$concat11, "".concat(token.antCls, "-menu-item-selected"), {
  ...
  }), (0, _defineProperty2.default)(_$concat11, "".concat(token.antCls, "-menu-submenu-selected"), {
  ...
  }), (0, _defineProperty2.default)(_$concat11, "".concat(token.antCls, "-menu:not(").concat(token.antCls, "-menu-horizontal)"), (_$concat$concat2 = {}, (0, _defineProperty2.default)(_$concat$concat2, "".concat(token.antCls, "-menu-item-selected"), {
  ...
  }), (0, _defineProperty2.default)(_$concat$concat2, "".concat(token.antCls, "-menu-item:hover, \n          ").concat(token.antCls, "-menu-item-active,\n          ").concat(token.antCls, "-menu-submenu-title:hover"), (0, _defineProperty2.default)({
...
var genProLayoutStyle = function genProLayoutStyle(token) {
  ...
  return _ref2 = {}, (0, _defineProperty2.default)(_ref2, "".concat(token.antCls, "-layout"), {
    backgroundColor: 'transparent !important'
  }), (0, _defineProperty2.default)(_ref2, token.componentCls, (_token$componentCls2 = {}, (0, _defineProperty2.default)(_token$componentCls2, "& ".concat(token.antCls, "-layout"), {
    display: 'flex',
    backgroundColor: 'transparent',
    width: '100%'
  }), (0, _defineProperty2.default)(_token$componentCls2, "".concat(token.componentCls, "-content"), {
    display: 'flex',
  ...
  }), (0, _defineProperty2.default)(_token$componentCls2, "".concat(token.componentCls, "-container"), {
    width: '100%',
    display: 'flex',
    flexDirection: 'column',
    minWidth: 0,
    minHeight: 0,
    backgroundColor: 'transparent'
  }), (0, _defineProperty2.default)(_token$componentCls2, "".concat(token.componentCls, "-bg-list"), {
    pointerEvents: 'none',
    position: 'fixed',
    overflow: 'hidden',
    insetBlockStart: 0,
