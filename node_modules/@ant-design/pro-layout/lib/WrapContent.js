...
var WrapContent = function WrapContent(props) {
  ...
  var contentClassName = (0, _classnames.default)("".concat(prefixCls, "-content"), hashId, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-has-header"), props.hasHeader), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-content-has-page-container"), hasPageContainer > 0), _classNames));
