 ...
 */
declare type ProHelpDataSourceContentType = {
    /**
     * h1 标题1类型的数据源子项内容。
     */
    h1: string;
 ...
 */
declare type ProHelpDataSourceChildrenType = Extract<keyof ProHelpDataSourceContentType, any>;
/**
 * ProHelp 数据源子项内容属性类型。
 ...
 */
declare type ProHelpDataSourceContentProps<ValueTypeMap, ValueType> = ValueType extends ProHelpDataSourceChildrenType ? ProHelpDataSourceContentType[ValueType] : ValueType extends keyof ValueTypeMap ? ValueTypeMap[ValueType] : ProHelpDataSourceContentType[ProHelpDataSourceChildrenType];
/**
 * ProHelp 数据源子项类型。
 ...
 */
export declare type ProHelpDataSourceChildren<ValueTypeMap = {
    text: string;
}> = {
    /**
     * 包含数据源子项内容的对象。
 ...
 */
export declare type ProHelpDataSource<ValueType = 'text'> = {
    /**
     * key 数据源项的唯一标识
     */
    key: string;
