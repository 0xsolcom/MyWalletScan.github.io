...
var genGlobalHeaderStyle = function genGlobalHeaderStyle(token) {
  ...
  return (0, _defineProperty2.default)({}, token.componentCls, (_token$componentCls = {
    ...
    minHeight: '22px',
    color: (_token$layout2 = token.layout) === null || _token$layout2 === void 0 ? void 0 : (_token$layout2$header = _token$layout2.header) === null || _token$layout2$header === void 0 ? void 0 : _token$layout2$header.colorHeaderTitle,
    fontSize: '18px',
