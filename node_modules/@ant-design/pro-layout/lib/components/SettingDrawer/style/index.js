...
var genSettingDrawerStyle = function genSettingDrawerStyle(token) {
  var _ref;
  return _ref = {}, (0, _defineProperty2.default)(_ref, "".concat(token.componentCls, "-handle"), {
    position: 'fixed',
    ...
    cursor: 'pointer',
    pointerEvents: 'auto'
  }), (0, _defineProperty2.default)(_ref, token.componentCls, {
    '&-content': {
      position: 'relative',
      minHeight: '100%',
    ...
    '&-list': (0, _defineProperty2.default)({}, "li".concat(token.antCls, "-list-item"), {
      paddingInline: 0,
      paddingBlock: 8
    })
  }), _ref;
