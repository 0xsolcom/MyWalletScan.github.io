...
export var ProHelpContentPanel = function ProHelpContentPanel(_ref) {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (list.at(0) !== selectedKey) {
              ...
              onScroll === null || onScroll === void 0 ? void 0 : onScroll(list.at(0));
            }
          case 5:
          case "end":
  ...
  useEffect(function () {
    ...
    (_divRef$current = divRef.current) === null || _divRef$current === void 0 ? void 0 : _divRef$current.addEventListener('scroll', onScrollEvent.run, false);
    return function () {
      var _divRef$current2;
      onScrollEvent.cancel();
      (_divRef$current2 = divRef.current) === null || _divRef$current2 === void 0 ? void 0 : _divRef$current2.removeEventListener('scroll', onScrollEvent.run, false);
    };
