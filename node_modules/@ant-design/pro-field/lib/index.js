...
var _excluded = ["fieldProps"],
  ...
  _excluded6 = ["placeholder"]; // import type {RangeInputNumberProps,ExtraProps as } from './components/DigitRange'
...
var ProFieldComponent = function ProFieldComponent(_ref, ref) {
  ...
  var fieldProps = (0, _react.useMemo)(function () {
    return (value !== undefined || _onChange || (rest === null || rest === void 0 ? void 0 : rest.fieldProps)) && (0, _objectSpread2.default)((0, _objectSpread2.default)({
      value: value
