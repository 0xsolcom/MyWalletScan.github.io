...
var FilterDropdown = function FilterDropdown(props) {
  ...
  return wrapSSR( /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.Popover, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    ...
    content: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ref: htmlRef,
      className: (0, _classnames.default)("".concat(prefixCls, "-overlay"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-overlay-").concat(placement), placement), (0, _defineProperty2.default)(_classNames, "hashId", hashId), _classNames)),
