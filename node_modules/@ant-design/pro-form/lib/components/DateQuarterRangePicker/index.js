...
var valueType = 'dateQuarterRange';
 ...
 * @param
 */
var DateQuarterRangePicker = /*#__PURE__*/_react.default.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Field.default, (0, _objectSpread2.default)({
    ...
    filedConfig: {
      ...
      lightFilterLabelFormatter: function lightFilterLabelFormatter(value) {
        return (0, _proUtils.dateArrayFormatter)(value, (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.format) || 'YYYY-W');
      }
    }
  }, rest));
});
var _default = DateQuarterRangePicker;
